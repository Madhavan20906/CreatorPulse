export const SEED_STATE = {
  "pulse": {
    ...
    "recommended": {
      ...
      "prediction": {
        "direction": "Above creator baseline",
        "confidence": 0.74,
    ...
    "recentActivity": [
      {
        "id": "activity-1",
        "agent": "Channel Brain",
        "action": "Analyzed channel library",
        "detail": "42 videos clustered into 4 topic groups",
        "timestamp": "2 min ago",
        "status": "complete"
      },
      {
        ...
        "action": "Found a content gap",
        "detail": "Production reliability is under-covered despite strong audience fit",
        "timestamp": "1 min ago",
        "status": "complete"
      },
      {
        ...
        "action": "Selected next move",
        "detail": "Why AI agents work in a demo but fail in production",
        "timestamp": "Just now",
        "status": "complete"
      }
    ]
  ...
  "opportunities": [
    ...
    },
    {
      ...
      "signals": [
        "Adjacent to your second-best video",
    ...
    },
    {
      ...
      "signals": [
        "Strong fit for Shorts",
        "Low production effort",
        "Moderate novelty"
      ],
      "prediction": {
        "direction": "Near creator baseline",
        "confidence": 0.61,
  ...
  "memory": {
    ...
    "topicMemory": [
      {
        "label": "AI agents",
        "signal": "Historically associated with stronger performance",
        "confidence": 94
      },
      {
        "label": "Python tutorials",
        "signal": "Audience fit is present but the library is saturated",
        "confidence": 72
      }
    ],
    "formatMemory": [
      {
        ...
        "signal": "Strongest long-form format",
        "confidence": 91
      },
      {
        "label": "Shorts",
        "signal": "Contrarian explainers outperform generic tips",
        "confidence": 86
      }
    ],
    "hookMemory": [
      {
        "label": "Contrarian",
        "signal": "High performance in recent uploads",
        "confidence": 89
      },
      {
        "label": "Generic educational",
        "signal": "Underperforms channel baseline",
        "confidence": 68
      }
    ],
    "timingMemory": [
      {
        "label": "Thursday 10:00",
        "signal": "Historically associated with stronger first-day velocity",
        "confidence": 64
      }
    ],
    "learnings": [
